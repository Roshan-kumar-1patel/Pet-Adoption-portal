            ...
            <?php 
                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo SITEURL; ?>dashbord/category-pets.php?category_id=<?php echo $id; ?>">
    ...
    <section class="pet-menu">
        <div class="container">
            ...
            //Getting pets from Database that are active and featured
            //SQL Query
        ...
        <p class="text-center">
            <a href="<?php echo SITEURL; ?>dashbord/pets.php">See All Pets</a>
        </p>
    </section>
