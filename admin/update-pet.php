                ...
                <td>
                    <?php 
                        ...
                        else
                        {
                            //Image Available
                            ?>
                            <img src="<?php echo SITEURL; ?>images/pet/<?php echo $current_image; ?>" width="150px">
                            <?php
                        }
                    ?>
                </td>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "Pet-Name-".rand(0000, 9999).'.'.$ext; //THis will be renamed image

                        //Get the Source Path and DEstination PAth
                        $src_path = $_FILES['image']['tmp_name']; //Source Path
                        $dest_path = "../images/pet/".$image_name; //DEstination Path
                ...
                if($res3==true)
                {
                    //Query Exectued and pet Updated
